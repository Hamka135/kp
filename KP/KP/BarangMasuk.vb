...
Public Class BarangMasuk
    ...
    Sub simpan()
        ...
        Else
            ...
            simpan = "INSERT INTO brg_masuk (IdBMasuk,IdBrg,NamaBarang,NamaSupplier,Jumlah,Tanggal) VALUES('" & TextBox1.Text & "','" & TextBox2.Text & "','" & ComboBox1.Text & "', '" & ComboBox2.Text & "', '" & TextBox3.Text & "', '" & TextBox4.Text & "')"

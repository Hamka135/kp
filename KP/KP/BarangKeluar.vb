...
Public Class BarangKeluar
    ...
    Sub simpan()
        ...
        Else
            ...
            simpan = "INSERT INTO brg_keluar (IdBKeluar,IdBrg,NamaBarang,NamaCostumer,Jumlah,Tanggal) VALUES('" & TextBox1.Text & "','" & TextBox2.Text & "','" & ComboBox1.Text & "', '" & ComboBox2.Text & "', '" & TextBox3.Text & "', '" & TextBox4.Text & "')"
    ...
    Sub edit()
        ...
        Else
            ...
            edit = "UPDATE brg_keluar SET IdBKeluar ='" & TextBox1.Text & "' , IdBrg = '" & TextBox2.Text & "', NamaBarang = '" & ComboBox1.Text & "', NamaCostumer = '" & ComboBox2.Text & "',Jumlah = '" & TextBox3.Text & "' ,Tanggal = '" & TextBox4.Text & "'WHERE IdBKeluar = '" & TextBox1.Text & "'"
    ...
    Sub tampilCB2()
        koneksi()
        cmd = New MySqlCommand("select NamaCostumer from costumer order by IdCostumer", con)
        rd = cmd.ExecuteReader
        While rd.Read
            ComboBox2.Items.Add(rd("NamaCostumer"))
        End While
    End Sub
